...
The trigrams appear to be less informative than the bigrams. Many of the trigrams include repetitive information with 6 of the top 10 including the phrase "environmental justice" with another, less inpactful word. Wherease the bigrams seem to include more individual topics, such as "public health", "air quality", and "vulnerable communities". 
...
```{r}
keyness_plots <- function(years, target){
