...
tokenized <- nytDat %>%
  # here: take paragraphs in and un-nest to word level (1 row for each word in paragraph)
...
tokenized_headline$clean <- clean_tokens # put the cleaned tokens into the `tokenized_headline` df `clean` column
