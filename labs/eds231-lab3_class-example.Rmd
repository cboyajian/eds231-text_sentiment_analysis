...
tweets$text <- gsub(pattern = "http[^[:space:]]*", 
                    replacement = "", 
                    x = tweets$text)
...
ggplot(output, 
  ...
  scale_fill_manual("legend", 
                    values = c("Positive" = "darkgreen", "Neutral" = "black", "Negative" = "darkred"))+
...
```{r quanteda_cleaning}
# tokenize the text so each doc (page, in this case) is a list of tokens (words)
